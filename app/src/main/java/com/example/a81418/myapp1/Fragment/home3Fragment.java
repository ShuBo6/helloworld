...
import com.example.a81418.myapp1.Activities.TeacherFaqiqiandao;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 1:
                    ...
                    break;
                case 2:
                    Log.e("msg=2", "失败");break;
                case 3:
                    Intent intent=new Intent(getContext(), TeacherFaqiqiandao.class);
...
//                .setIndicatorInterval(20)
    ...
    public void initlistFrag(){
        ...
        getFragmentManager().beginTransaction().replace(R.id.home_frag_list,listall).show(listall).commit();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mwangluo = getActivity().findViewById(R.id.xiaoyuanshouye);
            ...
            public void onClick(View v) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        Looper.prepare();
                        DataManager dataManager=new DataManager();
                        boolean f=dataManager.Initqiandao();
                        if (f){
                            Toast.makeText(getContext(),"成功发起签到",Toast.LENGTH_SHORT).show();
