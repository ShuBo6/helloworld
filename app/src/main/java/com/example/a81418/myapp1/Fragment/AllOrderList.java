...
public class AllOrderList extends Fragment {
...
private DataManager mdataManager=new DataManager();
    ...
    //统一的Fragment构建方法
    public AllOrderList newInstance(int flag) {
        Bundle args = new Bundle();
        //type代表页签，0：全部订单 1：待发货 2：待收货 3：已完成
        args.putInt("type", flag);
        AllOrderList fragment = new AllOrderList();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter=new OrderListAdapter(getContext(),1);
