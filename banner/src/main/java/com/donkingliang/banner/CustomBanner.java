...
//        drawable.setIntrinsicWidth(interval);
     ...
     * @return
     */
    public CustomBanner<T> setPages(ViewCreator<Integer> creator, ArrayList<Integer> data) {
        mAdapter =(BannerPagerAdapter<T>) new BannerPagerAdapter<Integer>(mContext, creator, data);
